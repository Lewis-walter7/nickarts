...
export default function Contact() {
    return (
        <div className="min-h-screen bg-dark glow-bg selection:bg-primary selection:text-white">
            <main className="relative pt-32 pb-5 px-8 max-w-7xl mx-auto">
                {/* Header */}
                ...
                <div className="grid lg:grid-cols-5 gap-16 items-start">
                    {/* Contact Form */}
                    <div className="lg:col-span-3 glass p-10 md:p-16 rounded-[40px] border border-white/5">
                        <form className="space-y-8">
                            ...
                            <div className="space-y-2">
                                ...
                                <select className="w-full bg-zinc-900 border border-white/10 rounded-2xl px-6 py-4 text-white focus:outline-none focus:border-primary/50 transition-colors appearance-none">
                            ...
                            <button className="w-full bg-primary text-white font-black uppercase tracking-[0.2em] py-5 rounded-2xl hover:bg-primary-hover shadow-[0_0_40px_rgba(255,77,0,0.2)] transition-all">
                                Send Message
                            </button>
                        </form>
                    </div>
                    ...
                    <div className="lg:col-span-2 space-y-12 pt-8">
                        <div className="space-y-4">
                            <h3 className="text-zinc-500 font-black uppercase text-xs tracking-[0.3em]">The Studio</h3>
                        ...
                        <div className="space-y-4">
                            <h3 className="text-zinc-500 font-black uppercase text-xs tracking-[0.3em]">Communication</h3>
                        ...
                        <div className="space-y-4">
                            <h3 className="text-zinc-500 font-black uppercase text-xs tracking-[0.3em]">Social Flows</h3>
