                    ...
                    <div className="lg:col-span-5 h-fit lg:sticky lg:top-32">
                        ...
                        {work.isSold ? (
                            <div className="flex flex-col gap-4">
                                <div className="w-full py-4 rounded-xl bg-emerald-500/10 border border-emerald-500/30 flex items-center justify-center gap-3 text-emerald-400 font-bold">
                                ...
                                <a
                                    ...
                                    className="w-full bg-white/10 text-white font-bold py-4 rounded-xl hover:bg-white/20 transition-all flex items-center justify-center gap-2 backdrop-blur-md border border-white/5"
                                >
                            ...
                            <div className="flex flex-col gap-4">
                                ...
                                <a
                                    href={`mailto:nickartsstudio@gmail.com?subject=${encodeURIComponent(`Inquiry: ${work.title}`)}&body=${encodeURIComponent(`Hi, I'm interested in acquiring "${work.title}" (${work.year}). Please let me know if it's still available.`)}`}
