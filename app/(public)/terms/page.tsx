            ...
            <main className="relative pt-32 pb-20 px-6 md:px-8 max-w-4xl mx-auto">
                ...
                <div className="flex flex-col gap-6 mb-20">
                    ...
                    <h1 className="text-4xl md:text-6xl font-black tracking-tight leading-[0.9] text-white">
                        Terms of <span className="text-primary accent-display">Service.</span>
                    </h1>
                ...
                <div className="space-y-12">
                    {points.map((point, i) => (
                        <div key={i} className="glass p-8 md:p-12 rounded-3xl border-white/5 group hover:border-primary/20 transition-all">
